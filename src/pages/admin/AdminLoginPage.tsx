...
export const AdminLoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#071324] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md bg-[#0A192F] border border-slate-800 rounded-xl shadow-2xl p-8 space-y-6 text-white">
        {/* Header */}
        <div className="text-center space-y-3">
          <div className="w-16 h-16 rounded bg-white p-1.5 flex items-center justify-center mx-auto shadow-md border border-slate-700">
            <BrandLogo variant="symbol" className="w-full h-full" />
          </div>
          <h2 className="text-xl font-black tracking-tight text-white">AMM AUTOMATION</h2>
        ...
        <div className="bg-slate-900/80 border border-slate-700/80 p-3 rounded text-xs space-y-1">
          ...
          <p className="text-slate-400 font-mono text-[11px]">Email: admin@ammautomation.com</p>
          <p className="text-slate-400 font-mono text-[11px]">Password: Admin@12345</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-[#071324] border border-slate-700 rounded pl-9 pr-3 py-2 text-sm text-white focus:outline-none focus:border-orange-500"
              />
            </div>
          </div>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-orange-600 hover:bg-orange-500 disabled:opacity-50 text-white font-semibold text-sm py-2.5 rounded shadow transition-all flex items-center justify-center gap-2"
          >
