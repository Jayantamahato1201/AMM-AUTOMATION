        ...
        <div className="w-full max-w-7xl 2xl:max-w-[1536px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10">
            ...
            <div className="lg:col-span-5 space-y-5 sm:space-y-6">
              <div>
                <span className="text-[#F27D26] font-bold tracking-[0.25em] sm:tracking-[0.3em] uppercase text-xs sm:text-sm block mb-1">
                  OFFICIAL COMMUNICATION
                </span>
                <h2 className="text-fluid-h2 font-bold text-[#0A192F] dark:text-white leading-snug">
              ...
              <div className="space-y-4">
                {/* Email */}
                <div className="bg-white dark:bg-[#0A192F] p-4 sm:p-5 border border-slate-200 dark:border-slate-800 border-l-4 border-l-[#0A192F] dark:border-l-slate-700 shadow-sm flex items-start gap-3 sm:gap-4">
                  ...
                  <div className="min-w-0">
                    ...
                    <a
                      href={`mailto:${email}`}
                      className="text-xs sm:text-sm font-semibold text-[#0A192F] dark:text-white hover:text-[#F27D26] dark:hover:text-[#F27D26] transition-colors block mt-0.5 break-all"
                    >
                      {email}
                    </a>
                    <span className="text-[11px] text-slate-500 dark:text-slate-400 block mt-0.5">Official proposals & procurement inquiries</span>
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-[#0A192F] p-4 sm:p-5 border border-slate-200 dark:border-slate-800 border-l-4 border-l-[#0A192F] dark:border-l-slate-700 shadow-sm flex items-start gap-3 sm:gap-4">
                  ...
                  <div className="min-w-0">
                    <h4 className="text-xs font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500">Phone / WhatsApp</h4>
                    <a
                      href={`tel:${phone.replace(/\s+/g, '')}`}
                      className="text-xs sm:text-sm font-semibold text-[#0A192F] dark:text-white hover:text-[#F27D26] dark:hover:text-[#F27D26] transition-colors block mt-0.5"
                    >
                      {phone}
                    </a>
                    <span className="text-[11px] text-slate-500 dark:text-slate-400 block mt-0.5">Direct technical desk & emergency on-call</span>
                  </div>
                </div>

                {/* WhatsApp Quick CTA */}
                <div className="bg-[#0A192F] dark:bg-[#071324] p-4 sm:p-5 text-white border border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  <div>
                    <h4 className="text-xs sm:text-sm font-bold text-white uppercase tracking-wider">Instant WhatsApp Chat</h4>
                  ...
                  <a
                    ...
                    className="bg-[#25D366] hover:bg-[#20bd5a] text-white text-xs font-bold uppercase tracking-wider px-4 py-2.5 shadow transition-colors inline-flex items-center justify-center gap-1.5 cursor-pointer shrink-0"
                  >
                ...
                {/* Address & Hours */}
                <div className="bg-white dark:bg-[#0A192F] p-4 sm:p-5 border border-slate-200 dark:border-slate-800 border-l-4 border-l-slate-300 dark:border-l-slate-600 shadow-sm space-y-3 text-xs text-slate-600 dark:text-slate-300">
                  <div className="flex items-start gap-3">
                    <MapPin className="w-4 h-4 text-[#F27D26] shrink-0 mt-0.5" />
                    <div>
                      <span className="font-bold text-[#0A192F] dark:text-white uppercase tracking-wider block">Engineering Workshop & Office</span>
                      <span>{address}</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 pt-2 border-t border-slate-100 dark:border-slate-800">
                    ...
                    <div>
                      <span className="font-bold text-[#0A192F] dark:text-white uppercase tracking-wider block">Operating Hours</span>
            ...
            <div className="lg:col-span-7">
              <div className="bg-white dark:bg-[#0A192F] p-5 sm:p-8 border border-slate-200 dark:border-slate-800 shadow-sm">
                <div className="border-b border-slate-100 dark:border-slate-800 pb-4 mb-6">
                  <span className="text-[#F27D26] font-bold tracking-[0.3em] uppercase text-xs block mb-1">
                    ONLINE SUBMISSION
                  </span>
                  <h3 className="text-xl sm:text-2xl font-bold text-[#0A192F] dark:text-white">
                ...
                {successMessage ? (
                  <div className="text-center py-10 space-y-4">
                    ...
                    <h4 className="text-xl font-bold text-[#0A192F] dark:text-white">Enquiry Dispatched Successfully</h4>
                    <p className="text-xs text-slate-600 dark:text-slate-300 max-w-md mx-auto leading-relaxed">
                      {successMessage}
                    </p>
                    <button
                      onClick={() => setSuccessMessage(null)}
                      className="mt-4 bg-[#0A192F] dark:bg-[#F27D26] text-white text-xs font-bold uppercase tracking-wider px-5 py-2.5 cursor-pointer"
                    >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    {errorMessage && (
                      <div className="bg-red-50 dark:bg-red-950/50 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-300 text-xs p-3 flex items-center gap-2">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 px-3 py-2 text-sm text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:border-[#F27D26] focus:bg-white dark:focus:bg-slate-800"
                        />
                      </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <select
                          ...
                          className="w-full bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 px-3 py-2 text-sm text-slate-900 dark:text-white focus:outline-none focus:border-[#F27D26] focus:bg-white dark:focus:bg-slate-800"
                        >
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 px-3 py-2 text-sm text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:border-[#F27D26] focus:bg-white dark:focus:bg-slate-800 resize-none"
                      />
                    </div>
                    ...
                    <div className="pt-2">
                      <button
                        ...
                        className="w-full bg-[#F27D26] hover:bg-[#d96a1a] disabled:opacity-50 text-white font-bold text-xs uppercase tracking-widest py-4 transition-all flex items-center justify-center gap-2 cursor-pointer shadow-xs"
                      >
                        {isSubmitting ? (
                    ...
                    <p className="text-[11px] text-slate-500 dark:text-slate-400 text-center pt-1 font-mono">
